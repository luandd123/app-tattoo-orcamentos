...
const NAV = [
  ...
  { href: "/configuracoes",      label: "Configurações",    icon: "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.13.41.45.74.86.96.4.22.66.6.66 1.04v0c0 .44-.26.82-.66 1.04-.41.22-.73.55-.86.96z" },
    ...
    <div className="flex min-h-screen">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-30 h-14 flex items-center justify-between px-4 bg-[#0d0d11]/95 backdrop-blur border-b border-[#202028]">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-[8px] bg-gradient-to-br from-ink to-[#7a1c2c] flex items-center justify-center font-display font-bold text-white text-[14px]">T</div>
      ...
      {drawerOpen && <div className="lg:hidden fixed inset-0 bg-black/60 backdrop-blur-sm z-40" onClick={()=>setDrawerOpen(false)}/>}

      <aside className={`w-[260px] shrink-0 bg-gradient-to-b from-[#121217] to-[#0d0d11] border-r border-[#202028] px-5 py-7 flex flex-col gap-1.5
